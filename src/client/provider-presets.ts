 ...
 */
export const STRATEGY_PRESETS: Record<Exclude<SearchStrategy, "custom">, StrategyPreset> = {
  recommended: {
    providerOptions: {},
  },
  fast: {
...
export const STRATEGY_IDS: Array<Exclude<SearchStrategy, "custom">> = ["recommended", "fast", "quality", "cheap"];