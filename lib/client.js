      ...
      ` }),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SettingsGroup, {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingsRow, {
							...
							subtitle: platformState?.platforms?.xiaohongshu?.authenticated ? `${t("platformAccountPrefix")}${platformState.platforms.xiaohongshu.account?.name ?? t("platformConnected")}` : t("platformNotLoggedIn"),
							trailing: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: {
									display: "inline-flex",
									alignItems: "center",
							...
							title: t("xTitle"),
							subtitle: platformState?.platforms?.x?.authenticated ? `${t("platformAccountPrefix")}${platformState.platforms.x.account?.handle ?? t("platformConnected")}` : t("platformNotLoggedIn"),
							trailing: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: {
									display: "inline-flex",
									alignItems: "center",
