      ...
      ` }),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SettingsGroup, {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingsRow, {
							...
							title: t("xTitle"),
							subtitle: (config.platformEnabled?.x ?? true) === false ? t("platformDisabled") : platformState?.platforms?.x?.authenticated ? `${t("platformAccountPrefix")}${platformState.platforms.x.account?.handle ?? t("platformConnected")}` : platformState?.platforms?.x?.sessionEstablished ? t("platformSessionSaved") : t("platformNotLoggedIn"),
							trailing: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									display: "inline-flex",
									alignItems: "center",
