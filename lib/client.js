...
`;
		...
		*/
		...
		const zhDict = {
			...
			routingLabel: "当前搜索策略",
			routingConfigure: "编辑",
			"routingPolicy.ordered": "始终从首选开始",
			"routingPolicy.round-robin": "依次轮换起点",
		...
		const enDict = {
			...
			"routingPolicy.ordered": "Always start with preferred",
			"routingPolicy.round-robin": "Rotate the starting source",
