		...
		function ProviderControls(props) {
			...
			switch (provider) {
				case "exa": {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AdvancedDelay, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(NumberField, {
				...
				case "tavily": {
					...
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AdvancedDelay, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						style: {
							display: "flex",
							alignItems: "center",
							gap: 10
				...
				case "brave": {
					...
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(AdvancedDelay, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						style: {
							display: "flex",
							alignItems: "center",
							gap: 10
				...
				case "you": {
					...
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AdvancedDelay, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							gap: 14,
							flexWrap: "wrap"
				...
				case "parallel": {
					...
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AdvancedDelay, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Segmented, {
						options: [
							{
								value: "auto",
								label: "自动"
...
<path d="M81.1293 91.3261H192.438C192.729 92.501 193.019 93.6939 193.291 94.8869H267.128C264.479 86.6084 261.067 78.6734 256.948 71.1722H186.051C186.504 72.3471 186.94 73.5401 187.375 74.733H86.1921C85.6296 76.3056 85.0852 77.8781 84.5771 79.4687H12.464C11.3934 81.8004 10.3772 84.1683 9.43359 86.5904H82.4177C81.9822 88.1629 81.5467 89.7354 81.1474 91.3261H81.1293Z" fill="#1D1C1A"/>
      ...
      ` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
		...
		*/
		...
		//#endregion
		//#region src/client/SearchStrategyCard.tsx
		/**
		...
		* @module
		*/
		function SearchStrategyCard(props) {
			const { t, current, onApply, disabled } = props;
			const options = [
				{
					id: "recommended",
					icon: "⭐",
					title: t("strategyRecommended"),
					desc: t("strategyRecommendedDesc")
				},
				{
					id: "fast",
					icon: "⚡",
					title: t("strategyFast"),
					desc: t("strategyFastDesc")
				},
				{
					id: "quality",
					icon: "🎯",
					title: t("strategyQuality"),
					desc: t("strategyQualityDesc")
				},
				{
					id: "cheap",
					icon: "💰",
					title: t("strategyCheap"),
					desc: t("strategyCheapDesc")
				},
				{
					id: "custom",
					icon: "⚙",
					title: t("strategyCustom"),
					desc: t("strategyCustomDesc")
				}
			];
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				role: "radiogroup",
		...
		//#endregion
		//#region src/client/provider-presets.ts
		/**
		...
		*  No quota, rank, or self-hosted label on the card. */
		...
		function WebToolsSection(props) {
			...
			const [strategyBusy, setStrategyBusy] = (0, react.useState)(false);
			...
			const applyStrategy = async (strategy) => {
				...
				try {
					...
					if (strategy !== "custom") {
						...
						const merged = {};
						for (const pv of config.providers) if (pv.options && Object.keys(pv.options.overrides).length > 0) merged[pv.name] = { ...pv.options.overrides };
						for (const [name, opts] of Object.entries(preset.providerOptions)) merged[name] = {
							...merged[name] ?? {},
							...opts
						};
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
								...
								children: t("strategyHint")
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SearchStrategyCard, {
							t,
