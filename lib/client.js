		...
		*/
		function formatProviderOptionsSummary(providerName, effective) {
			...
			switch (providerName) {
				...
				case "parallel": return String(effective.mode ?? "advanced") === "basic" ? "快速搜索" : "高质量搜索 · 推荐";
				default: return "推荐设置";
			}
		}
		//#endregion
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						style: {
							fontSize: 12,
							color: isDef ? text.secondary : state.business,
							marginTop: 2
						},
						children: formatProviderOptionsSummary(p.name, eff)
					...
					children: [
						p.name === "exa" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							style: {
								display: "block",
								fontSize: 12,
								fontWeight: 500,
						...
						p.name === "tavily" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							style: {
								display: "block",
								fontSize: 12,
								fontWeight: 500,
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "basic",
									children: "平衡搜索（1 credit，推荐）"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "fast",
									children: "快速搜索（1 credit）"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "ultra-fast",
									children: "极速搜索（1 credit）"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "advanced",
									children: "高质量搜索（2 credits）"
								})
							]
						})] }),
						p.name === "brave" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							style: {
								display: "block",
								fontSize: 12,
								fontWeight: 500,
							...
							onChange: (e) => setDraft({
								...draft,
								endpointPreference: e.target.value
							}),
							style: {
								width: "100%",
								padding: "6px 8px",
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "auto",
									children: "智能上下文 · 推荐（LLM Context，失败自动回退）"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "llm-context",
									children: "仅智能上下文（LLM Context）"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "web-search",
									children: "传统网页搜索"
						...
						p.name === "you" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							style: {
								display: "block",
								fontSize: 12,
								fontWeight: 500,
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								value: "highlights",
								children: "AI 相关片段（推荐，质量更高）"
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								value: "none",
								children: "简短摘要（轻量）"
							})]
						})] }),
						p.name === "parallel" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							style: {
								display: "block",
								fontSize: 12,
								fontWeight: 500,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [!isDef && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: handleReset,
								disabled: saving,
								style: {
								...
								children: saving ? "保存中..." : "保存偏好"
							})]
						}),
						msg && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								fontSize: 12,
								color: state.business,
								textAlign: "right"
							},
							children: msg
						})
