      ...
      ` }),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SettingsGroup, {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingsRow, {
							...
							subtitle: bridgeState?.platforms?.xiaohongshu?.authenticated ? `${t("platformAccountPrefix")}${bridgeState.platforms.xiaohongshu.account?.accountLabel ?? t("platformConnected")}` : t("xiaohongshuDesc"),
							trailing: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [bridgeState?.platforms?.xiaohongshu?.authenticated ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, {
									...
									style: {
										fontSize: 12,
										color: bridgeState?.platforms?.xiaohongshu?.authenticated ? text.primary : text.tertiary
									},
									children: bridgeState?.platforms?.xiaohongshu?.authenticated ? t("platformConnected") : t("platformNotConnected")
								})]
							})
							...
							title: t("xTitle"),
							subtitle: bridgeState?.platforms?.x?.authenticated ? `${t("platformAccountPrefix")}${bridgeState.platforms.x.account?.accountLabel ?? t("platformConnected")}` : t("xDesc"),
							trailing: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									display: "inline-flex",
									alignItems: "center",
								...
								children: [bridgeState?.platforms?.x?.authenticated ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, {
									...
									style: {
										fontSize: 12,
										color: bridgeState?.platforms?.x?.authenticated ? text.primary : text.tertiary
									},
									children: bridgeState?.platforms?.x?.authenticated ? t("platformConnected") : t("platformNotConnected")
								})]
							}),
							isLast: true
						})]
...
`;
		...
		*/
		...
		const zhDict = {
			...
			platformSourcesTagline: "通过本地 Browser Bridge 使用真实浏览器已登录会话搜索小红书与 Twitter/X，Host 零保存 Cookie。",
			...
			xiaohongshuDesc: "搜索真实小红书生活与经验笔记，支持保留完整 xsec_token 签名链接与正文提取。",
			xTitle: "Twitter / X",
			xDesc: "搜索 X/推特 实时动态与观点，支持 from:、since: 等原生语法与推文提取。",
			connectPlatform: "连接账号",
		...
		const enDict = {
			...
			platformSourcesTagline: "Search Xiaohongshu and Twitter/X using real authenticated browser sessions via local Browser Bridge with zero cookie storage on Host.",
			...
			xiaohongshuDesc: "Search real notes, preserving complete xsec_token signed links and full page text.",
			xTitle: "Twitter / X",
			xDesc: "Search real-time posts and opinions on X with from:, since: operators and tweet text.",
			connectPlatform: "Connect Account",
