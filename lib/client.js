					...
					children: [
						...
						dash && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("a", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t(dash.labelKey) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, { size: 14 })]
							})]
						})
					]
				});
...
`;
		...
		*/
		...
		const zhDict = {
			...
			"capability.exa": "网页搜索 · 内容获取",
			"capability.tavily": "网页搜索 · 内容提取",
			"capability.brave": "网页搜索",
			"capability.you": "网页搜索 · 内容获取",
			"capability.firecrawl": "网页搜索 · 页面读取",
			"capability.parallel": "网页搜索 · 内容提取",
			"capability.jina": "网页搜索 · 页面读取",
			"capability.searxng": "自建网页搜索",
		...
		const enDict = {
			...
			"capability.exa": "Web Search · Content",
