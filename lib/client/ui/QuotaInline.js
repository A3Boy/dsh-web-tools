...
export function QuotaCard(props) {
    ...
    if (!quota || !quota.supported || quota.source === "dashboard") {
        ...
        return (_jsxs("div", { style: cardShell(embedded), children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [_jsx("span", { style: { fontSize: 12, fontWeight: 600, color: text.tertiary }, children: t("quotaTitle") }), _jsx(RefreshButton, { refreshing: refreshing, onRefresh: () => void refresh(), title: t("refreshQuota") })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [_jsx("span", { style: { fontSize: 13, color: text.secondary }, children: isLocalMetered
