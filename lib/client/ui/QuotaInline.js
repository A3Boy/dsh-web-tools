...
import {} from "../api.js";
import { quotaFraction, quotaTier, quotaSourceLabel } from "../logic.js";
...
export function QuotaCard(props) {
    ...
    if (meteredNames.has(providerName ?? "")) {
        ...
        return (_jsxs("div", { style: { display: "flex", flexDirection: "column" }, children: [_jsxs("div", { className: "dswt-settings-row", style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "11px 16px", minHeight: 54 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [_jsx("span", { style: { color: text.secondary, display: "inline-flex" }, children: _jsx(IconCard, {}) }), _jsx("span", { style: { fontSize: 13, fontWeight: 500, color: text.primary }, children: t("billingMethod") })] }), _jsx("span", { style: { fontSize: 13, color: text.secondary }, children: t("quotaMeteredPrefix") })] }), isLocalMetered && (_jsxs("div", { className: "dswt-settings-row", style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "11px 16px", minHeight: 54 }, children: [_jsx("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: _jsx("span", { style: { fontSize: 13, fontWeight: 500, color: text.primary }, children: t("localUsage") }) }), _jsx("span", { style: { fontSize: 13, color: text.secondary }, children: t("localUsageTimes", { n: quota.used }) })] })), dash && (_jsxs("a", { href: dash.url, target: "_blank", rel: "noreferrer", className: "dswt-settings-row clickable", style: {
                        display: "flex",
                        alignItems: "center",
                        ...
                        textDecoration: "none",
                        fontSize: 13,
                    }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [_jsx("span", { style: { color: text.secondary, display: "inline-flex" }, children: _jsx(IconConsole, {}) }), _jsx("span", { style: { fontWeight: 500 }, children: t("dashboardLabel") })] }), _jsxs("div", { style: { display: "inline-flex", alignItems: "center", gap: 6, color: text.secondary }, children: [_jsx("span", { children: t(dash.labelKey) }), _jsx(IconChevronRightOutline14, { size: 14 })] })] }))] }));
    }
    // Fallback card when no quota snapshot or for dashboard-only providers
    if (!quota || !quota.supported || quota.source === "dashboard") {
        return (_jsx("div", { style: { display: "flex", flexDirection: "column" }, children: dash && (_jsxs("a", { href: dash.url, target: "_blank", rel: "noreferrer", className: "dswt-settings-row clickable", style: {
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "space-between",
                    padding: "11px 16px",
    ...
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10, padding: "12px 14px", borderTop: `1px solid ${surface.border}` }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [_jsx("span", { style: { fontSize: 12, fontWeight: 600, color: text.tertiary }, children: isUsdBalance ? t("quotaBalance") : t("quotaTitle") }), fraction !== undefined && (_jsxs("span", { style: { fontSize: 12, fontWeight: 500, color: text.secondary, fontVariantNumeric: "tabular-nums" }, children: [Math.round(fraction * 100), "%"] }))] }), _jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 6 }, children: [_jsx("span", { style: { fontSize: 18, fontWeight: 600, color: text.primary, fontVariantNumeric: "tabular-nums" }, children: main }), unit && _jsx("span", { style: { fontSize: 12, color: text.tertiary }, children: unit })] }), fraction !== undefined && (_jsx("div", { style: { width: "100%", height: 5, borderRadius: 3, background: surface.layer2, overflow: "hidden" }, children: _jsx("div", { style: { width: `${Math.round(fraction * 100)}%`, height: "100%", background: barColor, transition: "width .3s ease" } }) })), _jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", fontSize: 11, color: text.tertiary, flexWrap: "wrap", gap: 6, paddingTop: 2 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [ago && _jsx("span", { children: ago }), _jsx(RefreshButton, { refreshing: refreshing, onRefresh: () => void refresh(), title: t("refreshQuota") })] }), dash && (_jsxs("a", { href: dash.url, target: "_blank", rel: "noreferrer", style: { color: "var(--dsw-alias-brand-primary)", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 4 }, children: [_jsx("span", { children: t(dash.labelKey) }), _jsx(ExternalLinkIcon, { size: 12 })] }))] })] }));
}
