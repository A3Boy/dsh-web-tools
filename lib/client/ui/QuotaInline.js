...
export function QuotaInline(props) {
    ...
    if (bravePendingSync) {
        return (_jsx("span", { style: { fontSize: 12, color: text.tertiary, whiteSpace: "nowrap", flex: "none" }, children: t ? `${t("quotaRequestsTitle")} · ${t("quotaBraveFirstSync")}` : `Request quota · ${quota.note ?? ""}` }));
    }
...
export function QuotaCard(props) {
    ...
    if (!quota || !quota.supported || quota.source === "dashboard") {
        ...
        return (_jsxs("div", { style: cardShell(embedded), children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [_jsx("span", { style: { fontSize: 12, fontWeight: 600, color: text.tertiary }, children: isBrave ? t("quotaRequestsTitle") : t("quotaTitle") }), _jsx(RefreshButton, { refreshing: refreshing, onRefresh: () => void refresh(), title: t("refreshQuota") })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [_jsx("span", { style: { fontSize: 13, color: text.secondary }, children: isBrave
