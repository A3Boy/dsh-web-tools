...
export function QuotaCard(props) {
    ...
    if (meteredNames.has(providerName ?? "")) {
        ...
        return (_jsxs("div", { style: { display: "flex", flexDirection: "column" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "11px 14px", borderTop: `1px solid ${surface.border}` }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [_jsx("span", { style: { color: text.secondary, display: "inline-flex" }, children: _jsx(IconCard, {}) }), _jsx("span", { style: { fontSize: 13, fontWeight: 500, color: text.primary }, children: t("billingMethod") })] }), _jsx("span", { style: { fontSize: 13, color: text.secondary }, children: t("quotaMeteredPrefix") })] }), isLocalMetered && (_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "11px 14px", borderTop: `1px solid ${surface.border}` }, children: [_jsx("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: _jsx("span", { style: { fontSize: 13, fontWeight: 500, color: text.primary }, children: t("localUsage") }) }), _jsx("span", { style: { fontSize: 13, color: text.secondary }, children: t("localUsageTimes", { n: quota.used }) })] })), dash && (_jsxs("a", { href: dash.url, target: "_blank", rel: "noreferrer", style: {
                        display: "flex",
                        alignItems: "center",
