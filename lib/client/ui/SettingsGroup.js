...
export function SettingsGroup(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6, ...style }, children: [(title || action) && (_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 2px" }, children: [title && _jsx("span", { style: { fontSize: 12, fontWeight: 600, color: text.tertiary, textTransform: "none" }, children: title }), action && _jsx("div", { children: action })] })), _jsx("div", { className: `dswt-group dswt-group-dividers-${dividers}`, style: {
                            display: "flex",
