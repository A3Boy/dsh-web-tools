...
export function SearchModeButton({ sessionId, label = "联网搜索", unavailableLabel = "没有可用的搜索源", }) {
    ...
    return (_jsxs("button", { type: "button", className: searchModeCss.trigger, "data-active": required || undefined, "data-loading": loading || undefined, "data-pending": pending || undefined, "data-unavailable": !available || undefined, "aria-busy": loading || pending || undefined, "aria-pressed": required, "aria-label": label, title: available ? label : unavailableLabel, disabled: !available || loading || pending, onMouseDown: (event) => {
