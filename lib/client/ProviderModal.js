...
export function ProviderModal(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
      ...
      ` }), _jsx(Modal, { open: true, onClose: onClose, title: p.label, closeLabel: t("close"), className: "wt-modal-dialog", contentClassName: "wt-modal-content", children: _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 14, paddingBottom: 8 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 0 2px" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [brand && (_jsx("img", { src: brand.icon, alt: p.label, width: 24, height: 24, style: { borderRadius: 5, flexShrink: 0 } })), _jsx("span", { style: { fontSize: 13, color: text.secondary }, children: t(`capability.${p.name}`) || "" }), showPreferred && _jsx("span", { style: { fontSize: 11, padding: "1px 6px", borderRadius: 4, background: "color-mix(in srgb, var(--dsw-alias-brand-primary) 12%, transparent)", color: "var(--dsw-alias-brand-primary)", fontWeight: 500 }, children: t("preferredProviderLabel") })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [status !== "ready" && (_jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 5 }, children: [statusState === "hollow" ? (_jsx("span", { "aria-hidden": true, style: { width: 8, height: 8, borderRadius: "50%", border: `1.5px solid ${text.tertiary}`, flex: "none", boxSizing: "border-box" } })) : (_jsx(StateDot, { state: statusState, size: 8 })), _jsx("span", { style: { color: statusColor, fontWeight: 500, fontSize: 12 }, children: statusText })] })), _jsx(Switch, { checked: p.enabled, onChange: onToggle, label: p.enabled ? t("enabledLabel") : t("disabledLabel") })] })] }), _jsxs(SettingsGroup, { children: [!selfHosted && (_jsx(CredentialDisclosure, { t: t, p: p, onChanged: onConfigChanged, onError: setLocalError, onTest: onTest, busy: busy, testResult: testResult })), (selfHosted || p.baseUrl !== undefined) && (_jsx(ConnectionSettingsDisclosure, { t: t, p: p, draftBaseUrl: draftBaseUrl, setDraftBaseUrl: setDraftBaseUrl, onBaseUrl: onBaseUrl }))] }), !selfHosted && _jsx(QuotaCard, { quota: quota, providerName: p.name, t: t, onRefresh: onRefreshQuota }), p.options && p.name !== "searxng" && (_jsx(SettingsGroup, { title: t("prefsTitle"), children: _jsx("div", { style: { padding: "12px 14px" }, children: _jsx(ProviderPreferencesSection, { t: t, p: p, onConfigChanged: onConfigChanged }) }) })), _jsx(SettingsGroup, { children: _jsx(DeveloperOptions, { t: t, p: p, onConfigChanged: onConfigChanged }) }), localError && _jsx("div", { style: { color: stateColor.danger, fontSize: 12 }, children: localError })] }) })] }));
}
