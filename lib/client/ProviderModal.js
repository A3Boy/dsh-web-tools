...
function ProviderPreferencesSection({ t, p, onConfigChanged }) {
    ...
    return (_jsxs("div", { style: { marginTop: 16, borderTop: `1px solid ${surface.border}`, paddingTop: 14 }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [_jsxs("div", { children: [_jsx("div", { style: { fontWeight: 600, fontSize: 13, color: text.primary }, children: "\u641C\u7D22\u504F\u597D" }), _jsx("div", { style: { fontSize: 12, color: isDef ? text.secondary : stateColor.business, marginTop: 2 }, children: formatProviderOptionsSummary(p.name, eff) })] }), _jsx("button", { type: "button", onClick: () => setExpanded(!expanded), style: { padding: "4px 10px", fontSize: 12, borderRadius: 4, cursor: "pointer", border: `1px solid ${surface.border}`, background: "transparent", color: text.primary }, children: expanded ? "收起" : "自定义" })] }), expanded && (_jsxs("div", { style: { marginTop: 12, display: "flex", flexDirection: "column", gap: 10, fontSize: 13 }, children: [p.name === "exa" && (_jsxs("div", { children: [_jsx("label", { style: { display: "block", fontSize: 12, fontWeight: 500, color: text.secondary, marginBottom: 4 }, children: "\u68C0\u7D22\u65B9\u5F0F" }), _jsxs("select", { value: draft.searchType ?? "auto", onChange: (e) => setDraft({ ...draft, searchType: e.target.value }), style: { width: "100%", padding: "6px 8px", borderRadius: 4, border: `1px solid ${surface.border}` }, children: [_jsx("option", { value: "auto", children: "\u81EA\u52A8\u5E73\u8861\uFF08\u63A8\u8350\uFF09" }), _jsx("option", { value: "fast", children: "\u5FEB\u901F\uFF08\u66F4\u4F4E\u5EF6\u8FDF\uFF09" }), _jsx("option", { value: "instant", children: "\u6781\u901F\uFF08\u6700\u4F4E\u5EF6\u8FDF\uFF09" }), _jsx("option", { value: "deep-lite", children: "\u6DF1\u5EA6\u6982\u89C8\uFF08\u8F83\u6162\uFF09" }), _jsx("option", { value: "deep", children: "\u6DF1\u5EA6\u68C0\u7D22\uFF08\u6162\uFF09" }), _jsx("option", { value: "deep-reasoning", children: "\u6DF1\u5EA6\u63A8\u7406\uFF08\u6700\u8BE6\u5C3D\uFF09" })] })] })), p.name === "tavily" && (_jsxs("div", { children: [_jsx("label", { style: { display: "block", fontSize: 12, fontWeight: 500, color: text.secondary, marginBottom: 4 }, children: "\u68C0\u7D22\u6DF1\u5EA6" }), _jsxs("select", { value: draft.searchDepth ?? "basic", onChange: (e) => setDraft({ ...draft, searchDepth: e.target.value }), style: { width: "100%", padding: "6px 8px", borderRadius: 4, border: `1px solid ${surface.border}` }, children: [_jsx("option", { value: "basic", children: "\u5E73\u8861\u641C\u7D22\uFF081 credit\uFF0C\u63A8\u8350\uFF09" }), _jsx("option", { value: "fast", children: "\u5FEB\u901F\u641C\u7D22\uFF081 credit\uFF09" }), _jsx("option", { value: "ultra-fast", children: "\u6781\u901F\u641C\u7D22\uFF081 credit\uFF09" }), _jsx("option", { value: "advanced", children: "\u9AD8\u8D28\u91CF\u641C\u7D22\uFF082 credits\uFF09" })] })] })), p.name === "brave" && (_jsxs("div", { children: [_jsx("label", { style: { display: "block", fontSize: 12, fontWeight: 500, color: text.secondary, marginBottom: 4 }, children: "\u68C0\u7D22\u6A21\u5F0F" }), _jsxs("select", { value: draft.endpointPreference ?? "auto", onChange: (e) => setDraft({ ...draft, endpointPreference: e.target.value }), style: { width: "100%", padding: "6px 8px", borderRadius: 4, border: `1px solid ${surface.border}` }, children: [_jsx("option", { value: "auto", children: "\u667A\u80FD\u4E0A\u4E0B\u6587 \u00B7 \u63A8\u8350\uFF08LLM Context\uFF0C\u5931\u8D25\u81EA\u52A8\u56DE\u9000\uFF09" }), _jsx("option", { value: "llm-context", children: "\u4EC5\u667A\u80FD\u4E0A\u4E0B\u6587\uFF08LLM Context\uFF09" }), _jsx("option", { value: "web-search", children: "\u4F20\u7EDF\u7F51\u9875\u641C\u7D22" })] })] })), p.name === "you" && (_jsxs("div", { children: [_jsx("label", { style: { display: "block", fontSize: 12, fontWeight: 500, color: text.secondary, marginBottom: 4 }, children: "\u68C0\u7D22\u5C55\u73B0" }), _jsxs("select", { value: draft.extractionMode ?? "highlights", onChange: (e) => setDraft({ ...draft, extractionMode: e.target.value }), style: { width: "100%", padding: "6px 8px", borderRadius: 4, border: `1px solid ${surface.border}` }, children: [_jsx("option", { value: "highlights", children: "AI \u76F8\u5173\u7247\u6BB5\uFF08\u63A8\u8350\uFF0C\u8D28\u91CF\u66F4\u9AD8\uFF09" }), _jsx("option", { value: "none", children: "\u7B80\u77ED\u6458\u8981\uFF08\u8F7B\u91CF\uFF09" })] })] })), p.name === "parallel" && (_jsxs("div", { children: [_jsx("label", { style: { display: "block", fontSize: 12, fontWeight: 500, color: text.secondary, marginBottom: 4 }, children: "\u68C0\u7D22\u8D28\u91CF" }), _jsxs("select", { value: draft.mode ?? "advanced", onChange: (e) => setDraft({ ...draft, mode: e.target.value }), style: { width: "100%", padding: "6px 8px", borderRadius: 4, border: `1px solid ${surface.border}` }, children: [_jsx("option", { value: "advanced", children: "\u9AD8\u8D28\u91CF\u641C\u7D22\uFF08\u63A8\u8350\uFF09" }), _jsx("option", { value: "basic", children: "\u5FEB\u901F\u641C\u7D22" })] })] })), _jsxs("div", { style: { display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 8 }, children: [!isDef && (_jsx("button", { type: "button", onClick: handleReset, disabled: saving, style: { padding: "4px 10px", fontSize: 12, borderRadius: 4, cursor: "pointer", border: `1px solid ${surface.border}`, background: "transparent", color: text.secondary }, children: "\u6062\u590D\u63A8\u8350" })), _jsx("button", { type: "button", onClick: handleSave, disabled: saving, style: { padding: "4px 12px", fontSize: 12, borderRadius: 4, cursor: "pointer", border: "none", background: stateColor.business, color: "#fff" }, children: saving ? "保存中..." : "保存偏好" })] }), msg && _jsx("div", { style: { fontSize: 12, color: stateColor.business, textAlign: "right" }, children: msg })] }))] }));
}
