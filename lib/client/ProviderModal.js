...
import { providerStatusOf, testOutcomeStatus, quotaSourceLabel } from "./logic.js";
...
function CredentialDisclosure(props) {
    ...
    const summaryColor = keys.length === 0
        ...
        : allHealthy
            ? text.secondary
            : stateColor.danger;
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column" }, children: [_jsxs("button", { type: "button", className: "dswt-settings-row clickable", onClick: () => setOpen(!open), style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, width: "100%", border: "none", background: "transparent", cursor: "pointer", padding: "11px 16px", minHeight: 54, fontFamily: "inherit", color: "inherit" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [_jsx("span", { style: { color: text.secondary, display: "inline-flex" }, children: _jsx(IconKey, {}) }), _jsx("span", { style: { fontWeight: 500, fontSize: 13, color: text.primary }, children: t("credentials") })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [_jsx("span", { style: { fontSize: 12, fontWeight: allHealthy ? 400 : 500, color: summaryColor }, children: summaryText }), _jsx("span", { style: { transform: open ? "rotate(90deg)" : "none", transition: "transform .15s ease", color: text.tertiary, display: "inline-flex", flex: "none" }, children: _jsx(IconChevronRightOutline14, { size: 14 }) })] })] }), open && p.keyWritable && (_jsx("div", { style: { padding: "0 16px 14px", display: "flex", flexDirection: "column", gap: 8 }, children: _jsx(CredentialList, { t: t, p: p, onChanged: onChanged, onError: onError, onTest: onTest, busy: busy, testResult: testResult }) }))] }));
}
...
export function ProviderModal(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
      ...
      ` }), _jsx(Modal, { open: true, onClose: onClose, title: p.label, headless: true, className: "wt-modal-dialog", contentClassName: "wt-modal-content", children: _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12, marginBottom: 2 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 14 }, children: [brand && (_jsx("img", { src: brand.icon, alt: p.label, width: 44, height: 44, style: { borderRadius: 10, flexShrink: 0 } })), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 3 }, children: [_jsx("h2", { style: { margin: 0, fontSize: 20, fontWeight: 600, lineHeight: "26px", color: text.primary }, children: p.label }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: text.tertiary }, children: [_jsx("span", { children: t(`capability.${p.name}`) || "" }), showPreferred && _jsxs("span", { children: ["\u00B7 ", t("preferredProviderLabel")] })] })] })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, paddingTop: 4 }, children: [status !== "ready" && (_jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 5 }, children: [statusState === "hollow" ? (_jsx("span", { "aria-hidden": true, style: { width: 8, height: 8, borderRadius: "50%", border: `1.5px solid ${text.tertiary}`, flex: "none", boxSizing: "border-box" } })) : (_jsx(StateDot, { state: statusState, size: 8 })), _jsx("span", { style: { color: statusColor, fontWeight: 500, fontSize: 12 }, children: statusText })] })), _jsx(Switch, { checked: p.enabled, onChange: onToggle, label: p.enabled ? t("enabledLabel") : t("disabledLabel") }), _jsx("button", { type: "button", onClick: onClose, "aria-label": t("close"), style: {
                                                display: "inline-flex",
                                                alignItems: "center",
