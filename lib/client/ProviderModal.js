...
import { providerStatusOf, testOutcomeStatus, quotaSummary, quotaFraction, quotaTier, quotaRemainingLabel, quotaDisplayKind } from "./logic.js";
...
function QuotaSection(props) {
    ...
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6, paddingTop: 4 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [_jsx("span", { style: { fontWeight: 600, fontSize: 13, color: text.primary }, children: t("quotaTitle") }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [_jsx("span", { style: { fontSize: 13, color: text.secondary, fontWeight: 500 }, children: label }), _jsx(Button, { size: "sm", variant: "ghost", icon: _jsx(IconRefreshOutline16, { size: 12 }), onClick: () => void refresh(), disabled: refreshing, style: { padding: "2px 4px" }, children: t("refreshQuota") })] })] }), fraction !== undefined && (_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [_jsx("div", { style: { flex: 1, height: 4, borderRadius: 2, background: surface.layer2, overflow: "hidden" }, children: _jsx("div", { style: { width: `${fraction * 100}%`, height: "100%", background: barColor, transition: "width .3s ease" } }) }), _jsxs("span", { style: { fontSize: 11, fontWeight: 600, color: text.tertiary }, children: [Math.round(fraction * 100), "%"] })] })), meta && _jsx("span", { style: { color: text.tertiary, fontSize: 11 }, children: meta }), quota.breakdown && Object.keys(quota.breakdown).length > 0 && (_jsxs("span", { style: { color: text.tertiary, fontSize: 11 }, children: [t("usage"), ": ", Object.entries(quota.breakdown).map(([k, v]) => `${k} ${v}`).join(" · ")] }))] }));
}
...
export function ProviderModal(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
      ...
      ` }), _jsx(Modal, { open: true, onClose: onClose, title: p.label, closeLabel: t("close"), description: t(`capability.${p.name}`) || "", className: "wt-modal-dialog", contentClassName: "wt-modal-content", footer: _jsx("div", { style: { display: "flex", justifyContent: "flex-end", width: "100%" }, children: _jsx(Button, { variant: "ghost", onClick: onClose, children: t("close") }) }), children: _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 14 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [_jsx("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: status !== "ready" && (_jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 6 }, children: [statusState === "hollow" ? (_jsx("span", { "aria-hidden": true, style: { width: 8, height: 8, borderRadius: "50%", border: `1.5px solid ${text.tertiary}`, flex: "none", boxSizing: "border-box" } })) : (_jsx(StateDot, { state: statusState, size: 8 })), _jsx("span", { style: { color: statusColor, fontWeight: 500, fontSize: 13 }, children: statusText })] })) }), _jsx("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: _jsx(Switch, { checked: p.enabled, onChange: onToggle, label: p.enabled ? t("enabledLabel") : t("disabledLabel") }) })] }), quota && _jsx(QuotaSection, { quota: quota, t: t, onRefresh: onRefreshQuota }), !selfHosted && (_jsx(CredentialDisclosure, { t: t, p: p, onChanged: onConfigChanged, onError: setLocalError, onTest: onTest, busy: busy, testResult: testResult })), (selfHosted || p.baseUrl !== undefined) && (_jsx(ConnectionSettingsDisclosure, { t: t, p: p, draftBaseUrl: draftBaseUrl, setDraftBaseUrl: setDraftBaseUrl, onBaseUrl: onBaseUrl })), _jsx(ProviderPreferencesSection, { t: t, p: p, onConfigChanged: onConfigChanged }), _jsx(DeveloperOptions, { t: t, p: p, onConfigChanged: onConfigChanged }), localError && _jsx("div", { style: { color: stateColor.danger, fontSize: 12 }, children: localError })] }) })] }));
}
