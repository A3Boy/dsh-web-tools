...
export function ProviderModal(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
      ...
      ` }), _jsx(Modal, { open: true, onClose: onClose, title: p.label, headless: true, className: "wt-modal-dialog", contentClassName: "wt-modal-content", children: _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [brand && (_jsx("img", { src: brand.icon, alt: p.label, width: 36, height: 36, style: { borderRadius: 8, flexShrink: 0 } })), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 2 }, children: [_jsx("h2", { style: { margin: 0, fontSize: 18, fontWeight: 600, lineHeight: "24px", color: text.primary }, children: p.label }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: text.tertiary }, children: [_jsx("span", { children: t(`capability.${p.name}`) || "" }), showPreferred && _jsxs("span", { children: ["\u00B7 ", t("preferredProviderLabel")] })] })] })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, paddingTop: 2 }, children: [status !== "ready" && (_jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 5 }, children: [statusState === "hollow" ? (_jsx("span", { "aria-hidden": true, style: { width: 8, height: 8, borderRadius: "50%", border: `1.5px solid ${text.tertiary}`, flex: "none", boxSizing: "border-box" } })) : (_jsx(StateDot, { state: statusState, size: 8 })), _jsx("span", { style: { color: statusColor, fontWeight: 500, fontSize: 12 }, children: statusText })] })), _jsx(Switch, { checked: p.enabled, onChange: onToggle, label: p.enabled ? t("enabledLabel") : t("disabledLabel") }), _jsx("button", { type: "button", onClick: onClose, "aria-label": t("close"), style: {
                                                display: "inline-flex",
                                                alignItems: "center",
