...
function CredentialDisclosure(props) {
    ...
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6, padding: "10px 14px", borderTop: `1px solid ${surface.border}` }, children: [_jsxs("div", { role: "button", tabIndex: 0, "aria-expanded": open, onClick: () => setOpen(!open), onKeyDown: (e) => { if ((e.key === "Enter" || e.key === " ") && canOpen) {
                    e.preventDefault();
                    setOpen(!open);
