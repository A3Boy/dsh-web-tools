...
import { SearchStrategyCard } from "./SearchStrategyCard.js";
import { STRATEGY_PRESETS } from "./provider-presets.js";
...
function ProviderCard(props) {
    ...
    return (_jsxs("div", { draggable: draggable, onDragStart: onDragStart, onDragOver: onDragOver, onDrop: onDrop, onDragEnd: onDragEnd, onClick: onClick, className: "wt-provider-row", role: "button", tabIndex: 0, onKeyDown: (e) => { if (e.key === "Enter" || e.key === " ") {
            ...
            e.currentTarget.style.background = surface.layer1; }, children: [draggable && (_jsx("span", { "aria-hidden": true, style: { color: text.tertiary, fontSize: 14, cursor: "grab", userSelect: "none", flex: "none" }, children: "\u283F" })), PROVIDER_BRAND[p.name] && (_jsx("img", { src: PROVIDER_BRAND[p.name].icon, alt: "", width: 24, height: 24, style: { borderRadius: 6, flex: "none" } })), _jsx("span", { style: { fontWeight: 500, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: "none" }, children: p.label }), isDefault && (_jsx("span", { style: { color: accentText(), fontSize: 11, fontWeight: 600, border: "1px solid currentColor", borderRadius: 4, padding: "0 6px", whiteSpace: "nowrap" }, children: t("defaultProviderLabel") })), _jsxs("span", { style: { marginLeft: "auto", display: "inline-flex", alignItems: "center", gap: 6, flex: "none" }, children: [dotState === "hollow" ? (_jsx("span", { "aria-hidden": true, style: { width: 8, height: 8, borderRadius: "50%", border: `1.5px solid ${text.tertiary}`, flex: "none", boxSizing: "border-box" } })) : (_jsx(StateDot, { state: dotState, size: 8 })), _jsx("span", { style: { color: statusColor, fontSize: 12, whiteSpace: "nowrap" }, children: statusText })] }), _jsx(IconChevronRightOutline14, { size: 14 })] }));
}
function accentText() {
...
export function WebToolsSection(props) {
    ...
    const applyStrategy = async (strategy) => {
        ...
        try {
            const patch = { searchStrategy: strategy };
            if (strategy !== "custom") {
    ...
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 22, maxWidth: 720, padding: "4px 0 24px" }, children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("div", { style: { display: "flex", alignItems: "flex-start", gap: 12 }, children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("h2", { style: { margin: 0, fontSize: 20, fontWeight: 600, lineHeight: "28px", color: text.primary }, children: t("title") }), _jsx("p", { style: { margin: "4px 0 0", fontSize: 14, lineHeight: "22px", color: text.secondary }, children: t("tagline") })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, paddingTop: 2, flex: "none", flexWrap: "wrap", justifyContent: "flex-end" }, children: [_jsxs("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: text.secondary, whiteSpace: "nowrap" }, children: [_jsx("span", { children: t("uiLanguage") }), _jsxs("select", { value: uiPref, onChange: (e) => {
                ...
                }, children: [_jsx("strong", { style: { color: stateColor.warning, fontSize: 13 }, children: t("proxyDegradedTitle") }), _jsx("span", { children: t("proxyDegradedBody") })] })), _jsxs("section", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 8 }, children: [_jsx("h3", { style: { margin: 0, fontSize: 15, fontWeight: 600, color: text.primary }, children: t("strategyLabel") }), _jsx("span", { style: { color: text.tertiary, fontSize: 12 }, children: t("strategyHint") })] }), _jsx(SearchStrategyCard, { t: t, current: config.searchStrategy ?? "recommended", onApply: applyStrategy, disabled: strategyBusy })] }), _jsxs("div", { style: {
                    display: "flex",
                    alignItems: "center",
                    gap: 16,
                    padding: "10px 14px",
