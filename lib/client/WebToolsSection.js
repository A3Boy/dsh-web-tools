...
function ProviderCard(props) {
    ...
    return (_jsxs("div", { onClick: onClick, className: "wt-provider-row", role: "button", tabIndex: 0, onKeyDown: (e) => { if (e.key === "Enter" || e.key === " ") {
        ...
        }, onMouseEnter: (e) => { e.currentTarget.style.background = surface.hover; }, onMouseLeave: (e) => { e.currentTarget.style.background = surface.layer1; }, children: [PROVIDER_BRAND[p.name] && (_jsx("img", { src: PROVIDER_BRAND[p.name].icon, alt: "", width: 24, height: 24, style: { borderRadius: 6, flex: "none" } })), _jsx("span", { style: { fontWeight: 500, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: "none" }, children: p.label }), isDefault && (_jsx("span", { style: { color: accentText(), fontSize: 11, fontWeight: 600, border: "1px solid currentColor", borderRadius: 4, padding: "0 6px", whiteSpace: "nowrap" }, children: t("preferredProviderLabel") })), _jsxs("span", { style: { marginLeft: "auto", display: "inline-flex", alignItems: "center", gap: 6, flex: "none" }, children: [dotState === "hollow" ? (_jsx("span", { "aria-hidden": true, style: { width: 8, height: 8, borderRadius: "50%", border: `1.5px solid ${text.tertiary}`, flex: "none", boxSizing: "border-box" } })) : (_jsx(StateDot, { state: dotState, size: 8 })), _jsx("span", { style: { color: statusColor, fontSize: 12, whiteSpace: "nowrap" }, children: statusText })] }), _jsx(IconChevronRightOutline14, { size: 14 })] }));
}
function accentText() {
...
export function WebToolsSection(props) {
    ...
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 22, maxWidth: 720, padding: "4px 0 24px" }, children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("div", { style: { display: "flex", alignItems: "flex-start", gap: 12 }, children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("h2", { style: { margin: 0, fontSize: 20, fontWeight: 600, lineHeight: "28px", color: text.primary }, children: t("title") }), _jsx("p", { style: { margin: "4px 0 0", fontSize: 14, lineHeight: "22px", color: text.secondary }, children: t("tagline") })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, paddingTop: 2, flex: "none", flexWrap: "wrap", justifyContent: "flex-end" }, children: [_jsxs("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: text.secondary, whiteSpace: "nowrap" }, children: [_jsx("span", { children: t("uiLanguage") }), _jsxs("select", { value: uiPref, onChange: (e) => {
                                            ...
                                            fontSize: 12,
                                            cursor: "pointer",
                                        }, children: [_jsx("option", { value: "auto", children: t("uiLangAuto") }), _jsx("option", { value: "zh", children: "\u4E2D\u6587" }), _jsx("option", { value: "en", children: "English" })] })] }), _jsx(Switch, { checked: config.enabled, onChange: setEnabled, label: config.enabled ? t("enabledLabel") : t("disabledLabel") }), saving && _jsx("span", { style: { color: text.tertiary, fontSize: 12 }, children: t("saving") }), saved && !saving && _jsx("span", { style: { color: stateColor.success, fontSize: 12 }, children: t("saved") })] })] }), error && _jsx("div", { style: { color: stateColor.danger, fontSize: 13 }, children: error }), config.proxy?.configured === true && config.proxy?.degraded === true && (_jsxs("div", { style: {
                    display: "flex",
                    ...
                    color: text.secondary,
                }, children: [_jsx("strong", { style: { color: stateColor.warning, fontSize: 13 }, children: t("proxyDegradedTitle") }), _jsx("span", { children: t("proxyDegradedBody") })] })), _jsxs("section", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [_jsx("h3", { style: { margin: 0, fontSize: 15, fontWeight: 600, color: text.primary }, children: t("routingLabel") }), _jsx("span", { style: { marginLeft: "auto" }, children: _jsx(Button, { size: "sm", variant: "ghost", icon: _jsx(IconEditOutline16, { size: 14 }), onClick: () => setRoutingOpen(true), children: t("routingConfigure") }) })] }), _jsxs("div", { style: {
                            display: "flex",
                            flexDirection: "column",
                            gap: 4,
                            padding: "9px 14px",
                            ...
                            fontSize: 13,
                            color: text.secondary,
                        }, children: [_jsx("span", { style: { fontWeight: 600, color: text.primary }, children: t(`routingPolicy.${config.searchRoutingPolicy ?? "ordered"}`) }), _jsx("span", { style: { fontSize: 12 }, children: t(`routingPolicyHint.${config.searchRoutingPolicy ?? "ordered"}`) }), _jsx("span", { style: { fontSize: 12, color: text.tertiary, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: orderedProviders.map((name) => providerOf(name)?.label ?? name).join(" → ") })] })] }), _jsxs("section", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 8 }, children: [_jsx("h3", { style: { margin: 0, fontSize: 15, fontWeight: 600, color: text.primary }, children: t("providersLabel") }), _jsx("span", { style: { color: text.tertiary, fontSize: 12 }, children: t("readySummary", { n: readyCount, total: config.providers.length }) }), _jsx("span", { style: { marginLeft: "auto" }, children: _jsx(Button, { size: "sm", variant: "ghost", onClick: handleResetAll, disabled: resettingAll, children: resettingAll ? t("resetting") : t("resetAll") }) })] }), _jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: renderedProviders.map((p) => {
                            const testResult = providerTestResults[p.name];
                            return (_jsx(ProviderCard, { t: t, p: p, quota: quotas?.[p.name], testResult: testResult, inOrder: orderedProviders.includes(p.name), isDefault: p.name === config.defaultProvider, onClick: () => setDetailFor(p.name) }, p.name));
