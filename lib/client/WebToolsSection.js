                    ...
                    color: text.secondary,
                                ...
                                : platformState?.platforms?.xiaohongshu?.authenticated
                                    ...
                                    : platformState?.platforms?.xiaohongshu?.sessionEstablished
                                        ...
                                        : t("platformNotLoggedIn"), trailing: _jsxs("div", { style: { display: "inline-flex", alignItems: "center", gap: 10 }, children: [(config.platformEnabled?.xiaohongshu ?? true) && (platformState?.platforms?.xiaohongshu?.authenticated ? (_jsxs(_Fragment, { children: [_jsx(StateDot, { state: "done", size: 6 }), _jsx(Button, { size: "sm", variant: "ghost", onClick: () => void resetPlatformSession("xiaohongshu"), children: t("clearSessionButton") })] })) : (_jsx(Button, { size: "sm", variant: "outline", onClick: () => void loginPlatform("xiaohongshu"), children: t("loginButton") }))), _jsx(Switch, { checked: config.platformEnabled?.xiaohongshu ?? true, onChange: (v) => togglePlatform("xiaohongshu", v), label: t("xiaohongshuTitle") })] }) }), _jsx(SettingsRow, { icon: _jsx("div", { style: { width: 22, height: 22, borderRadius: 6, background: "#000", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: "bold" }, children: "\uD835\uDD4F" }), title: t("xTitle"), subtitle: (config.platformEnabled?.x ?? true) === false
                                ? t("platformDisabled")
                                : platformState?.platforms?.x?.authenticated
                                    ...
                                    : platformState?.platforms?.x?.sessionEstablished
                                        ? t("platformSessionSaved")
                                        : t("platformNotLoggedIn"), trailing: _jsxs("div", { style: { display: "inline-flex", alignItems: "center", gap: 10 }, children: [(config.platformEnabled?.x ?? true) && (platformState?.platforms?.x?.authenticated ? (_jsxs(_Fragment, { children: [_jsx(StateDot, { state: "done", size: 6 }), _jsx(Button, { size: "sm", variant: "ghost", onClick: () => void resetPlatformSession("x"), children: t("clearSessionButton") })] })) : (_jsx(Button, { size: "sm", variant: "outline", onClick: () => void loginPlatform("x"), children: t("loginButton") }))), _jsx(Switch, { checked: config.platformEnabled?.x ?? true, onChange: (v) => togglePlatform("x", v), label: t("xTitle") })] }), isLast: true })] }) }), _jsx("section", { children: _jsx(SettingsGroup, { title: t("providersLabel"), dividers: "inset", children: renderedProviders.map((p, idx) => {
