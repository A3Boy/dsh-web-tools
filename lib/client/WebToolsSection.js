...
import { Button, IconChevronRightOutline14, IconSearchOutline16, Input, StateDot, } from "@deepseek-ai/dsh-client-ui-primitives";
...
function ProviderRow(props) {
    ...
    const trailing = (_jsxs("div", { style: { display: "inline-flex", alignItems: "center", gap: 12 }, children: [status !== "ready" ? (_jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 6, flex: "none" }, children: [dotState === "hollow" ? (_jsx("span", { "aria-hidden": true, style: { width: 8, height: 8, borderRadius: "50%", border: `1.5px solid ${text.tertiary}`, flex: "none", boxSizing: "border-box" } })) : (_jsx(StateDot, { state: dotState, size: 8 })), _jsx("span", { style: { color: statusColor, fontSize: 12, whiteSpace: "nowrap" }, children: statusText })] })) : (_jsx(QuotaInline, { quota: quota, providerName: p.name, t: t })), editMode && inOrder && (_jsx("button", { type: "button", onClick: (e) => { e.stopPropagation(); onRemove?.(); }, "aria-label": t("removeFromChain"), title: t("removeFromChain"), style: {
                    display: "inline-flex",
                    alignItems: "center",
                    ...
                    outline: "none",
                }, onMouseEnter: (e) => (e.currentTarget.style.opacity = "0.85"), onMouseLeave: (e) => (e.currentTarget.style.opacity = "1"), children: _jsx("svg", { width: "10", height: "2", viewBox: "0 0 10 2", fill: "currentColor", children: _jsx("rect", { width: "10", height: "2", rx: "1" }) }) })), editMode && !inOrder && (_jsx(Button, { size: "sm", variant: "outline", onClick: (e) => { e.stopPropagation(); onAdd?.(); }, style: { padding: "0 8px", height: 24 }, children: t("addToChain") }))] }));
    return (_jsx("div", { onDragOver: onDragOver, onDragLeave: onDragLeave, onDrop: onDrop, style: {
        ...
        }, children: _jsx(SettingsRow, { icon: brandIcon, title: p.label, subtitle: showPreferred ? _jsx("span", { style: { color: text.tertiary, fontSize: 12 }, children: t("preferredProviderLabel") }) : undefined, trailing: trailing, chevron: !editMode, isLast: isLast, insetDivider: true, onClick: !editMode ? onClick : undefined }) }));
}
function accentText() {
