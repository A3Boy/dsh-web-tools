...
export function WebToolsSection(props) {
    ...
    const [bridgeTicket, setBridgeTicket] = useState(null);
    ...
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 12, maxWidth: 720, padding: "4px 0 24px" }, children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("div", { style: { display: "flex", alignItems: "flex-start", gap: 12 }, children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("h2", { style: { margin: 0, fontSize: 16, fontWeight: 500, lineHeight: "24px", color: text.primary }, children: t("title") }), _jsx("p", { style: { margin: "2px 0 0", fontSize: 14, lineHeight: "22px", color: text.tertiary }, children: t("tagline") })] }), _jsx("div", { style: { display: "flex", alignItems: "center", gap: 8, paddingTop: 2, flex: "none", flexWrap: "wrap", justifyContent: "flex-end" }, children: _jsx(Switch, { checked: config.enabled, onChange: setEnabled, disabled: saving, label: config.enabled ? t("enabledLabel") : t("disabledLabel") }) })] }), error && _jsx("div", { style: { color: stateColor.danger, fontSize: 13 }, children: error }), versionInfo?.updateAvailable && versionInfo.latestVersion && versionInfo.releaseUrl && (_jsxs("div", { className: "dswt-update-banner", role: "status", children: [_jsxs("div", { className: "dswt-update-copy", children: [_jsx("strong", { children: t("updateAvailableTitle", { version: versionInfo.latestVersion }) }), _jsx("span", { children: t("updateAvailableBody", { current: versionInfo.currentVersion }) })] }), _jsxs("a", { className: "dswt-update-link", href: versionInfo.releaseUrl, target: "_blank", rel: "noreferrer", children: [t("viewUpdate"), _jsx(ExternalLinkIcon, { size: 12 })] })] })), config.proxy?.configured === true && config.proxy?.degraded === true && (_jsxs("div", { style: {
                    ...
                    color: text.secondary,
                                ...
                                ], value: config.searchRoutingPolicy ?? "ordered", onChange: (v) => saveOrder(orderedProviders, v) }), _jsx("div", { style: { marginTop: 8, fontSize: 12, color: text.tertiary }, children: t(`routingPolicyHint.${config.searchRoutingPolicy ?? "ordered"}`) })] }) }) })), _jsx("section", { children: _jsxs(SettingsGroup, { title: _jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }, children: [_jsx("span", { children: t("platformSourcesTitle") }), _jsxs("span", { style: { fontSize: 12, fontWeight: "normal", color: bridgeState?.connected ? stateColor.success : text.tertiary, display: "inline-flex", alignItems: "center", gap: 6 }, children: [bridgeState?.connected ? _jsx(StateDot, { state: "done", size: 6 }) : _jsx("span", { style: { width: 6, height: 6, borderRadius: "50%", background: surface.border } }), bridgeState?.connected ? t("bridgeStatusConnected") : t("bridgeStatusDisconnected")] })] }), children: [_jsx(SettingsRow, { icon: _jsx("div", { style: { width: 22, height: 22, borderRadius: 6, background: "#ff2442", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: "bold" }, children: "\u7EA2" }), title: t("xiaohongshuTitle"), subtitle: bridgeState?.platforms?.xiaohongshu?.authenticated
                                ? `${t("platformAccountPrefix")}${bridgeState.platforms.xiaohongshu.account?.accountLabel ?? t("platformConnected")}`
                                : t("xiaohongshuDesc"), trailing: _jsxs("div", { style: { display: "inline-flex", alignItems: "center", gap: 8 }, children: [bridgeState?.platforms?.xiaohongshu?.authenticated ? (_jsx(StateDot, { state: "done", size: 6 })) : (_jsx("span", { style: { width: 6, height: 6, borderRadius: "50%", background: surface.border } })), _jsx("span", { style: { fontSize: 12, color: bridgeState?.platforms?.xiaohongshu?.authenticated ? text.primary : text.tertiary }, children: bridgeState?.platforms?.xiaohongshu?.authenticated ? t("platformConnected") : t("platformNotConnected") })] }) }), _jsx(SettingsRow, { icon: _jsx("div", { style: { width: 22, height: 22, borderRadius: 6, background: "#000", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: "bold" }, children: "\uD835\uDD4F" }), title: t("xTitle"), subtitle: bridgeState?.platforms?.x?.authenticated
                                ? `${t("platformAccountPrefix")}${bridgeState.platforms.x.account?.accountLabel ?? t("platformConnected")}`
                                : t("xDesc"), trailing: _jsxs("div", { style: { display: "inline-flex", alignItems: "center", gap: 8 }, children: [bridgeState?.platforms?.x?.authenticated ? (_jsx(StateDot, { state: "done", size: 6 })) : (_jsx("span", { style: { width: 6, height: 6, borderRadius: "50%", background: surface.border } })), _jsx("span", { style: { fontSize: 12, color: bridgeState?.platforms?.x?.authenticated ? text.primary : text.tertiary }, children: bridgeState?.platforms?.x?.authenticated ? t("platformConnected") : t("platformNotConnected") })] }), isLast: true })] }) }), _jsx("section", { children: _jsx(SettingsGroup, { title: t("providersLabel"), dividers: "inset", children: renderedProviders.map((p, idx) => {
