...
function ProviderRow(props) {
    ...
    const trailing = (_jsxs("div", { style: { display: "inline-flex", alignItems: "center", gap: 12 }, children: [status !== "ready" ? (_jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 6, flex: "none" }, children: [dotState === "hollow" ? (_jsx("span", { "aria-hidden": true, style: { width: 8, height: 8, borderRadius: "50%", border: `1.5px solid ${text.tertiary}`, flex: "none", boxSizing: "border-box" } })) : (_jsx(StateDot, { state: dotState, size: 8 })), _jsx("span", { style: { color: statusColor, fontSize: 12, whiteSpace: "nowrap" }, children: statusText })] })) : (_jsx(QuotaInline, { quota: quota, providerName: p.name, t: t })), editMode && inOrder && (_jsx(Button, { size: "sm", variant: "ghost", onClick: (e) => { e.stopPropagation(); onRemove?.(); }, "aria-label": t("removeFromChain"), style: { padding: "0 6px", height: 24, color: stateColor.danger }, children: t("removeFromChain") })), editMode && !inOrder && (_jsx(Button, { size: "sm", variant: "outline", onClick: (e) => { e.stopPropagation(); onAdd?.(); }, style: { padding: "0 8px", height: 24 }, children: t("addToChain") }))] }));
