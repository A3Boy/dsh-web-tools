...
import { providerStatusOf, testOutcomeStatus, quotaSummary, quotaFraction, quotaDisplayKind, quotaRemainingLabel, quotaMetaLine, outcomeLabel, resolveUiLanguage, translateDict, } from "./logic.js";
...
function ProviderQuotaInline(props) {
    ...
    return (_jsxs("span", { style: { display: "flex", flexDirection: "column", gap: 3, flex: 1, minWidth: 120, alignItems: "flex-end", textAlign: "right" }, className: "wt-provider-quota", children: [_jsxs("span", { style: { display: "flex", alignItems: "center", gap: 6, justifyContent: "flex-end" }, children: [_jsx("span", { style: { color: text.secondary, fontSize: 12, whiteSpace: "nowrap" }, children: label }), fraction !== undefined && (_jsxs("span", { style: { color: fillColor, fontSize: 11, fontWeight: 600, whiteSpace: "nowrap" }, children: [Math.round(fraction * 100), "%"] }))] }), fraction !== undefined && (_jsx("span", { style: { width: 140, height: 4, borderRadius: 2, background: surface.layer2, overflow: "hidden", display: "block" }, children: _jsx("span", { style: { width: `${fraction * 100}%`, height: "100%", background: fillColor, display: "block" } }) })), meta && _jsx("span", { style: { color: text.tertiary, fontSize: 10, whiteSpace: "nowrap" }, children: meta })] }));
}
function accentText() {
