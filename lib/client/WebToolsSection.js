...
function ProviderRow(props) {
    ...
    const trailing = (_jsx("div", { style: { display: "inline-flex", alignItems: "center", gap: 10 }, children: status !== "ready" ? (_jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 6, flex: "none" }, children: [dotState === "hollow" ? (_jsx("span", { "aria-hidden": true, style: { width: 8, height: 8, borderRadius: "50%", border: `1.5px solid ${text.tertiary}`, flex: "none", boxSizing: "border-box" } })) : (_jsx(StateDot, { state: dotState, size: 8 })), _jsx("span", { style: { color: statusColor, fontSize: 12, whiteSpace: "nowrap" }, children: statusText })] })) : (_jsx(QuotaInline, { quota: quota })) }));
