...
function SettingInputRow(props) {
    ...
    return (_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }, children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 2 }, children: [_jsx("span", { style: { fontSize: 13, fontWeight: 500, color: text.primary }, children: label }), hint && _jsx("span", { style: { fontSize: 12, color: text.tertiary }, children: hint })] }), _jsxs("div", { style: { display: "inline-flex", alignItems: "center", gap: 6, flex: "none" }, children: [_jsx("input", { type: "number", value: value, placeholder: placeholder, onChange: (e) => onChange(e.target.value), style: {
                            height: 32,
                            width: 72,
                            padding: "0 8px",
                            borderRadius: 8,
                            ...
                            outline: "none",
                        } }), unit && _jsx("span", { style: { fontSize: 13, color: text.secondary }, children: unit })] })] }));
}
/** Dropdown menu trigger for selecting expert options (>4 items). */
function DropdownSelect(props) {
    const { label, valueLabel, items, onSelect } = props;
    const [open, setOpen] = useState(false);
    return (_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }, children: [_jsx("span", { style: { fontSize: 13, fontWeight: 500, color: text.primary }, children: label }), _jsx(Menu, { open: open, onClose: () => setOpen(false), items: items, onSelect: (id) => {
                    onSelect(id);
                    setOpen(false);
                }, anchor: _jsxs("button", { type: "button", onClick: () => setOpen(!open), style: {
                        display: "inline-flex",
                        alignItems: "center",
                        gap: 6,
                        height: 32,
                        ...
                        fontFamily: "inherit",
                        cursor: "pointer",
                    }, children: [_jsx("span", { children: valueLabel }), _jsx("span", { style: { display: "inline-flex", color: text.tertiary }, children: _jsx(IconChevronDownOutline14, { size: 14 }) })] }) })] }));
}
...
function ProviderControls(props) {
    ...
    switch (provider) {
        ...
        case "exa": {
            ...
            return (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsx(SectionLabel, { children: t("prefsExaModeLabel") }), _jsx(SegmentedControl, { style: { width: "100%" }, options: [
                                    { value: "auto", label: t("prefsExaAuto") },
                                    { value: "fast", label: t("prefsFast") },
                                    { value: "deep", label: t("prefsDeep") },
                                ], value: primaryValue, onChange: handlePrimaryMode }), _jsx("div", { style: { fontSize: 12, color: text.secondary, minHeight: 18 }, children: _jsx("span", { children: desc }) })] }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsx(SectionLabel, { children: t("prefsExaFreshnessLabel") }), _jsx(SegmentedControl, { style: { width: "100%" }, options: [
        ...
        case "tavily": {
            ...
            return (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsx(SectionLabel, { children: t("prefsTavilyDepthLabel") }), _jsx(SegmentedControl, { disabled: autoParams, style: { width: "100%" }, options: [
        ...
        case "brave": {
            ...
            return (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsx(SectionLabel, { children: t("prefsBraveModeLabel") }), _jsx(SegmentedControl, { style: { width: "100%" }, options: [
                                ...
                                ], value: pref, onChange: (v) => setValue("endpointPreference", v, "auto") }), _jsx("div", { style: { fontSize: 12, color: text.secondary, minHeight: 18 }, children: _jsx("span", { children: desc }) })] }), _jsxs(AdvancedDelay, { t: t, children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsx(SectionLabel, { children: t("prefsBraveThreshold") }), _jsx(SegmentedControl, { style: { width: "100%" }, options: [
        ...
        case "you": {
            ...
            return (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsx(SectionLabel, { children: t("prefsYouResultsLabel") }), _jsx(SegmentedControl, { style: { width: "100%" }, options: [
        ...
        case "jina": {
            ...
            return (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsx(SectionLabel, { children: t("prefsJinaModeLabel") }), _jsx(SegmentedControl, { style: { width: "100%" }, options: [
...
function SectionLabel(props) {
    return _jsx("span", { style: { fontSize: 13, fontWeight: 500, color: text.primary }, children: props.children });
}
function AdvancedDelay(props) {
    const [open, setOpen] = useState(false);
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10, marginTop: 6 }, children: [_jsxs("button", { type: "button", onClick: () => setOpen(!open), style: {
                    ...
                    cursor: "pointer",
                    fontFamily: "inherit",
                }, children: [_jsx("span", { style: { transform: open ? "rotate(90deg)" : "none", transition: "transform .15s ease", display: "inline-flex" }, children: _jsx(IconChevronRightOutline14, { size: 14 }) }), props.t("advancedParamsTitle")] }), open && (_jsx("div", { style: {
                    display: "flex",
