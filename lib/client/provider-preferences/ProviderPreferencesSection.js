...
function AdvancedDelay(props) {
    const [open, setOpen] = useState(false);
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10, marginTop: 4 }, children: [_jsxs("button", { type: "button", onClick: () => setOpen(!open), style: {
                    ...
                    cursor: "pointer",
                    fontFamily: "inherit",
                }, children: [_jsx("span", { style: { transform: open ? "rotate(90deg)" : "none", transition: "transform .15s ease", display: "inline-flex" }, children: _jsx(IconChevronRightOutline14, { size: 12 }) }), props.t("advancedParamsTitle")] }), open && (_jsx("div", { style: {
                    display: "flex",
