 ...
 */
export type AdvancedProviderFailureCode = "REQUEST_INVALID" | "OPTION_CONFLICT" | "UNSUPPORTED_CAPABILITY" | "AUTH" | "RATE_LIMIT" | "QUOTA" | "TIMEOUT" | "UPSTREAM" | "NETWORK" | "ABORTED";
...
export type AdvancedSearchOutcomeKind = "success" | "repair_required" | "provider_transition" | "configuration_error" | "provider_exhausted";
...
export type AdvancedSearchOutcome = AdvancedSearchSuccess | AdvancedSearchRepairRequired | AdvancedSearchProviderTransition | AdvancedSearchConfigurationError | AdvancedSearchProviderExhausted;
/**
...
export interface ProviderAdvancedContract<TRequest> {
     ...
     */
    validate(input: unknown, capabilities: ProviderCapabilityState): AdvancedValidationResult<TRequest>;
    /**
     * Execute the provider-native search. Never throws — on failure, return a
     * classified `AdvancedProviderFailure` via `classifyError`.
     */
    search(request: TRequest, context: AdvancedSearchExecutionContext): Promise<AdvancedSearchResult>;
