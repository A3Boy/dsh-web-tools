 ...
 */
export declare function quotaOf(providerName: string, apiKey: string, baseUrl: string | undefined, localUsdCents?: number, signal?: AbortSignal): Promise<QuotaSnapshot>;
