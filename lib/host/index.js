...
import { installSearchModeRuntime, SearchModeRuntime } from "./search-mode-runtime.js";
...
export function apply(ctx) {
    ...
    ctx.effect(() => installSearchModeRuntime(ctx, { searchAvailable: () => provider.available() }, searchModeRuntime, (input) => createUserMessage(input)), "dsh-web-tools: search-mode runtime");
