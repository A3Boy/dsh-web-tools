...
export const REQUIRED_SEARCH_TEXT = [
    ...
    "",
    "Search one concrete uncertainty at a time, or submit 1–4 specific queries in the `queries` array for parallel search. For named projects, APIs, or providers, include the exact name and relevant endpoint, error code, or code symbol. Prefer official documentation and repositories.",
    "",
    "If the first search returns only generic or irrelevant sources, refine the queries and search again.",
    "",
