...
import { extractXhsSearchState, extractVisibleXhsSearch, extractXhsDetailState, extractXhsNoteDetail, } from "./browser-scripts/xiaohongshu.js";
...
export class XiaohongshuSource {
    ...
    async experimentalNativeSearch(query, req, signal) {
