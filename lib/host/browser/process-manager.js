...
export function buildSafeLaunchArgs(profileDir, port, initialUrl, minimized = false) {
    const args = [
...
export async function launchBrowserProcess(browser, profileDir, initialUrl, minimized = false) {
